...
- main:
  ...
  - table:
    ...
    - rowgroup:
      - row "ນ້ຳຟ້າ ລາດ +8562011000014 ລາພັກ (Annual) 09/05/2026 – 11/05/2026 3 ວັນ ຂໍລາພັກປະຈຳປີ ອະນຸມັດ ປະຕິເສດ":
      ...
      - row "ນ້ຳຟ້າ ລາດ +8562011000014 ລາພັກ (Annual) 09/05/2026 – 11/05/2026 3 ວັນ ຂໍລາພັກປະຈຳປີ ອະນຸມັດ ປະຕິເສດ":
        ...
        - cell "ອະນຸມັດ ປະຕິເສດ":
          - button "ອະນຸມັດ"
          - button "ປະຕິເສດ"
      - row "ສຸດາ ທ +8562011000015 ລາພັກ (Annual) 07/04/2025 – 08/04/2025 2 ວັນ ຂໍລາພັກປະຈຳປີ ອະນຸມັດ ປະຕິເສດ":
        ...
        - cell "ອະນຸມັດ ປະຕິເສດ":
          - button "ອະນຸມັດ"
          - button "ປະຕິເສດ"
      - row "ຈັນທະລາ ສ້ານ +8562011000013 ລາໂດຍບໍ່ໄດ້ຮັບ (Unpaid) 15/04/2025 – 15/04/2025 1 ວັນ ກິດທຸລະສ່ວນຕົວ ອະນຸມັດ ປະຕິເສດ":
        ...
        - cell "ອະນຸມັດ ປະຕິເສດ":
          - button "ອະນຸມັດ"
          - button "ປະຕິເສດ"
      - row "ສົມສັກ ວົງສາ +8562011000001 ລາພັກ (Annual) 07/02/2025 – 07/02/2025 1 ວັນ ຂໍລາພັກປະຈຳປີ ອະນຸມັດ ປະຕິເສດ":
        ...
        - cell "ອະນຸມັດ ປະຕິເສດ":
          - button "ອະນຸມັດ"
          - button "ປະຕິເສດ"
      - row "ນາລີ ພົມມະ +8562011000002 ລາພັກ (Annual) 09/03/2026 – 13/03/2026 5 ວັນ ຂໍລາພັກປະຈຳປີ ອະນຸມັດ ປະຕິເສດ":
      ...
      - row "ນາລີ ພົມມະ +8562011000002 ລາພັກ (Annual) 09/03/2026 – 13/03/2026 5 ວັນ ຂໍລາພັກປະຈຳປີ ອະນຸມັດ ປະຕິເສດ":
        ...
        - cell "ອະນຸມັດ ປະຕິເສດ":
          - button "ອະນຸມັດ"
          - button "ປະຕິເສດ"
      - row "ບຸນມີ ສີສຸວັນ +8562011000004 ລາພັກ (Annual) 12/04/2025 – 14/04/2025 3 ວັນ ຂໍລາພັກປະຈຳປີ ອະນຸມັດ ປະຕິເສດ":
...
```ts
  ...
  9  |   })
  10 | 
  11 |   test('should show tabs "ລໍຖ້າອະນຸມັດ" and "ລາຍງານ"', async ({ page }) => {
  12 |     await expect(page.getByRole('button', { name: 'ລໍຖ້າອະນຸມັດ' })).toBeVisible()
  ...
  22 |     const firstApproveBtn = page.getByRole('button', { name: 'ອະນຸມັດ' }).first()
...
> 28 |     await expect(modal.getByText('ອະນຸມັດຄຳຂໍ')).toBeVisible({ timeout: 5_000 })
  ...
  33 |     await modal.getByRole('button', { name: 'ອະນຸມັດ' }).click()
  34 | 
